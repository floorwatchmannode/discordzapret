...
# <img src="https://cdn-icons-png.flaticon.com/128/5968/5968756.png" height=28 /> <a href="https://github.com/floorwatchmannode/">floorwatchmannode</a><a href="https://github.com/floorwatchmannode/discordzapret">/discordzapret</a> <img src="https://cdn-icons-png.flaticon.com/128/1384/1384060.png" height=28 />
...
> Если вы наткнулись на что-то вне репозитория `floorwatchmannode/discordzapret`, что распространяется от моего лица - **ФЕЙК**.
...
2. Скачайте архив (zip/rar) со [страницы последнего релиза](https://github.com/floorwatchmannode/discordzapret/releases/latest)
...
Если этого не произошло, то см. [#522](https://github.com/floorwatchmannode/discordzapret/issues/522)
...
- См. [#765](https://github.com/floorwatchmannode/discordzapret/issues/765)
...
- Скачайте последнюю версию [со страницы релизов](https://github.com/floorwatchmannode/discordzapret/releases/latest) (`zapret-discord-youtube-...`)
...
- См. также [#251](https://github.com/floorwatchmannode/discordzapret/discussions/251)
...
- См. также [#252](https://github.com/floorwatchmannode/discordzapret/discussions/252)
...
Если и это не помогло, создайте ветку обсуждений в разделе [Discussions](https://github.com/floorwatchmannode/discordzapret/discussions) (не в issues) и ждите помощи от других игроков.

### Не нашли своей проблемы

- Создайте её [тут](https://github.com/floorwatchmannode/discordzapret/issues)
...
Проект распространяется на условиях лицензии [MIT](https://github.com/floorwatchmannode/discordzapret/blob/main/LICENSE.txt)

## 🩷Благодарность участникам проекта

](https://github.com/floorwatchmannode/discordzapret/graphs/contributors)
